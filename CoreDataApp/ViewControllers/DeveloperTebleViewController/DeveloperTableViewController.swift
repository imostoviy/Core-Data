...
extension DeveloperTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: DevelopersTableViewCell.reuseIdentifier, for: indexPath) as! DevelopersTableViewCell
        ...
        cell.otherTask = object.anotherTask
